    ...
    <div id="wrapper">
        <div id="header-container">
            <ul class="secondary-nav">
                <li><?php print '<a href="showAllEmployee.php?adminId='.$adminId.'">BACK</a>'?></li>
                <li><?php print '<a href="adminHome.php?adminId='.$adminId.'">HOME</a>'?></li>
                <li><a href="index.php?logout=yes">LOGOUT</a></li>
            </ul>
        </div>
        <div class="alert alert-warning" role="alert">ARE YOU SURE YOU WANNA DELETE THIS EMPLOYEE DETAIL ??</div>
        <form action="deleteEmployee.php?adminId=<?php print $adminId ;?>" method="POST">
            <input type="hidden" name="adminId" value="<?php print $adminId;?>">
            <input type="hidden" name="empId" value="<?php print $employeeId;?>">
            <button type="submit" class="btn btn-primary">YES</button>
            <a href="showAllEmployee.php?adminId=<?php print $adminId ;?>" class="btn btn-primary">NO</a>
        </form>
        <footer>
