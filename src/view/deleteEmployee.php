 ...
 ?>
    ...
    <?php
        ...
        <ul class="secondary-nav">
            <li><a href="showAllEmployee.php?adminId='.$adminId.'">BACK</a></li>
            <li><a href="employeeHome.php?adminId='.$adminId.'">HOME</a></li>
            <li><a href="index.php?logout=yes">LOGOUT</a></li>

        </ul>'
    ?>
        <div class="alert alert-success" role="alert">EMPLOYEE DELETED !!</div>
...
<?php else: ?>
    ...
    ?>
            <h1>NO EMPLOYEE SELECTED FOR DELETION!</h1>
            <footer>
                <nav class="navbar navbar-default navbar-fixed-bottom">
                    <div class="container">
                        <span class="glyphicon glyphicon-copyright-mark" aria-hidden="false">CopyRight |PrashanthNaik 2015 ||</span>
